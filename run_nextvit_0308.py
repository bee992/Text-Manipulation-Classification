...
def run_train():
	...
	root_dir = '../user_data'
	out_dir  = root_dir + '/result/0308/NextViT-Base-1024-v00a-RandomSampler-CosineLR-lr2e4'
	...
	for fold in range(n_fold):
		...
		drop_last   = False,
		num_workers = 8, # 0 for debug in Windows
		pin_memory  = False,
		...
		nextvit = NextViT(True, '../user_data/nextvit_pretrained/nextvit_small_in1k_384.pth')
		net = nn.DataParallel(nextvit).cuda()
