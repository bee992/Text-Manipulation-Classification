...
def do_valid(net, valid_loader):
	...
	thres = np.percentile(pred_tampers, np.arange(90, 100, 1))
...
def run_train():
	...
	tampered_img_paths = "dataset/train/tampered/ensemble"
	...
	out_dir  = root_dir + '/result/0306/effb6-1024'
	...
	for fold in range(n_fold):
		...
		train_dataset = DTTDataset(train_df, augment=train_augment_v00)
		...
		# valid_train_loss = np.zeros(3,np.float32)
		...
		while iteration < num_iteration:
			for t, batch in enumerate((train_loader)):
				...
				# 	valid_train_loss = do_valid(net, train_loader)
				# 	pass
